...
module.exports = {
	...
	overrides: [
		...
		{
			// Test-file override: disable node-structure rules that are
			// only meaningful for real n8n node/credential classes.
			// Keeps general TS/style rules active.
			files: ['./nodes/**/*.test.ts', './credentials/**/*.test.ts'],
			plugins: ['eslint-plugin-n8n-nodes-base'],
			rules: {
				// node-class-description-* rules
				...
				'n8n-nodes-base/node-class-description-non-core-color-present': 'off',
				...
				'n8n-nodes-base/node-class-description-outputs-wrong': 'off',
				// node-dirname/filename/execute-block rules
				...
				'n8n-nodes-base/node-param-display-name-not-first-position': 'off',
				...
				'n8n-nodes-base/node-param-name-untrimmed': 'off',
		...
		{
			// Registry descriptor files are plain data objects (FieldDescriptor / ResourceDescriptor),
			// not n8n INodeProperties. Disable all node-param lint rules that fire false positives
			// on descriptor object literals.
